    ...
    with app.app_context():  # <<<<<< CRITICAL
        ...
        with db.session.no_autoflush:  # safe bulk ops
            ...
            db.session.bulk_save_objects(tasks_to_add=[    
                ...
                Task(name='Pushup Prowess', description="Do atleast 25 pushups in 1 min. You chest much touch you partner's fist on the ground", points=30, time_limit=1200),
                Task(name='The Way of the Pig', description='One partner must piggyback the other for 1.5 mins.', points=30, time_limit=1200),
                ...
                Task(name='Nerd Alert', description=r'Do the homework on the groupchat (no phone/calculator). Score 75%+.', points=30, time_limit=900),
                Task(name='Broadcasting Live', description='Send current location on group chat.', points=40, time_limit=300),
                Task(name='Iron Core', description='Plank for 2 min without body touching ground (except hands/feet).', points=30, time_limit=1200),
                ...
                Task(name='One Leg Wonder', description='Both partners may stand on 1 foot for 1 min without leaning on any object or partner.', points=10, time_limit=1200),
